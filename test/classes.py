...
class health_care_provider(user):
    ...
    def __init__(self, full_name = "", email_address = "", phone_number = "", provider_number = "", type = "", working_centre = [], password = ""):
        super().__init__(full_name, email_address, phone_number,password)
